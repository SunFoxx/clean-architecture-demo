...
/// Used to display message when active manufacturers list is empty
class NoMakesMessageWidget extends StatelessWidget {
  final VoidCallback onRetryPressed;

  const NoMakesMessageWidget({
    Key? key,
  ...
  Widget build(BuildContext context) {
    ...
    return InteractiveMessage(
      ...
      messageText: strings.noMakesMessage,
